...
// Servir el index principal situado en la raíz del proyecto (si existe)
app.get('/', (req, res) => {
...
const usuariosRouter = require('./Rourters/usuario');
const productosRouter = require('./Rourters/productos');
const comprasRouter = require('./Rourters/compras');
